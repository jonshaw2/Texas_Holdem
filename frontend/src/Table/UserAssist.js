...
export function playerAssist(playerState,playerHand,riverHand, deck){
  ...
  let playerCurrentHand = playerHand[0].map((item, i) => item)
  ...
  for (let i = 0; i<200; i++){
      ...
      let condition= winCondition(playerState,[playerCurrentHand,simHand],newRiverHand,[])
  ...
  let winChance = (counter[0]/(counter[0]+counter[1]))
return winChance;
